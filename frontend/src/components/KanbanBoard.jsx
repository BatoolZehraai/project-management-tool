        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
          {columns.map(col => (
            ...
            >
                  ...
                  col.tasks.map(task => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-3 pt-2.5 border-t border-inherit flex items-center justify-between text-[10.5px]">
                          {/* Assignee */}
                          <div className="flex items-center space-x-1.5">
                            <div
                            ...
                            <span className={`truncate max-w-[80px] text-[10px] font-medium ${isDarkMode ? 'text-zinc-400' : 'text-slate-600'}`}>
              ...
              {/* Inline Add Card */}
              {canAddTask && (
                <div className="pt-3 border-t border-inherit mt-auto">
